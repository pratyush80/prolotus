  ...
  return (
    <section className={classes.item}>
        <div className={classes.text}>
          <Image src='/svg/sos-svgrepo-com.svg' alt='sos image' height={80} width={100} />
          <h3>Your Safety First
            Keep your loved ones informed about your travel routes or call emergency services when in need
          </h3>
        </div>
        <div className={classes.text}>
          <Image src='/svg/customer-support-help-service-svgrepo-com.svg' alt='sos image' height={70} width={90} />
